...
<html data-ng-app="demoApp">
	 ...
	 <body>
		...
		<script>
		  ...
		  function gtag()"""),format.raw/*389.20*/("""{"""),format.raw/*389.21*/("""dataLayer.push(arguments);"""),format.raw/*389.47*/("""}"""),format.raw/*389.48*/("""
		  gtag('js', new Date());

		  gtag('config', 'UA-154365486-1');
		</script>
	 	<script src=""""),_display_(Seq[Any](/*394.18*/routes/*394.24*/.Assets.at("third/jquery/jquery-1.10.2.min.js"))),format.raw/*394.71*/("""" type="text/javascript"></script>
		<script src=""""),_display_(Seq[Any](/*395.17*/routes/*395.23*/.Assets.at("third/bootstrap/js/bootstrap.js"))),format.raw/*395.68*/("""" type="text/javascript"></script>
